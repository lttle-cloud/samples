...
After that you can access your Nginx server at `https://nginx-custom-dockerfile--samples--public--${tenant}.eu.lttle.host/` where `${tenant}` is your lttle.cloud tenant name.
