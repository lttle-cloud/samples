...
After that you can access your static site at `https://static-site--samples--public--${tenant}.eu.lttle.host/` where `${tenant}` is your lttle.cloud tenant name.

You can check our deployment of this sample [https://static-site--samples--public--aifrim.eu.lttle.host/](https://static-site--samples--public--aifrim.eu.lttle.host/).
